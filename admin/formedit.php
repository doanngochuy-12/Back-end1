                            ...
                            <form action="editproducts.php" method="post" class="form-horizontal"
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <input value="<?= $chiTietSP[0]['name']?>" type="text" class="span11" placeholder="Product name" name="name" required/> *
                                    </div>
                                </div>
                                <div class="control-group">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input value="<?= $chiTietSP[0]['price']?>" type="text" class="span11" placeholder="price" name="price" required/> *
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label">Feature :</label>
                                            <div class="controls">
                                                <input value="<?= $chiTietSP[0]['feature']?>" type="number" class="span11" name="feature" min="0" max="1" required/> *
                                            </div>
                                        </div>
